                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                         ...
                         Padding(
                             padding:EdgeInsets.only(top: 17,right: 195,left: 20),
                             child:Text(
                              "1. Community Service:-",
                          ...
                          Padding(
                            padding:EdgeInsets.only(top: 17,right: 253,left: 20),
                            child: Text(
                              "2. Club Service: ",
                              style:GoogleFonts.medulaOne(fontSize: 30,fontWeight: FontWeight.bold),
                            ),
                          ...
                          Padding(
                            padding:EdgeInsets.only(top: 17,right: 185,left: 20),
                            child: Text(
                          ...
                          Padding(
                            padding:EdgeInsets.only(top: 17,right: 152,left: 20),
                            child: Text(
